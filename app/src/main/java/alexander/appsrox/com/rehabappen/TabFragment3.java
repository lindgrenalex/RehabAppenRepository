...
public class TabFragment3 extends Fragment implements TextToSpeech.OnInitListener{
    ...
    private void promptSpeechInput() {
        ...
        tts.speak("Sovrum: " + currentTemperature + " grader", TextToSpeech.QUEUE_FLUSH, null);
