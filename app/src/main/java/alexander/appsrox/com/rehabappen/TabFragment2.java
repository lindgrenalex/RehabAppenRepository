...
public class TabFragment2 extends Fragment implements TextToSpeech.OnInitListener{
    ...
    private void promptSpeechInput() {
        ...
        tts.speak("Kök: " + currentTemperature + " grader", TextToSpeech.QUEUE_FLUSH, null);
